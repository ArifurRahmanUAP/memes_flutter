                ...
                TextField(
                  ...
                  onChanged: (searchText) {
                    ...
                    if(searchText.isEmpty) {
                      results = homeScreenController.memesResponseModel.value.data!.memes!;
                    } else {
                      results = homeScreenController.memesResponseModel.value.data!.memes!.where((element) => element.name!.toLowerCase().contains(searchText.toLowerCase())).toList();
                    }
                    homeScreenController.filteredMemes.value = results;
